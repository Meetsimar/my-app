...
export default function Home() {
  return (
    <div>
      ...
      </Row><div style={{backgroundColor: "rgba(0, 0, 0, 0.4)", padding: "8px"}}>
      <Row className="mt-4">
        <Col md={6}>
          <p>The Metropolitan Museum of Art, colloquially "the Met", is located in New York City and is the largest art 
